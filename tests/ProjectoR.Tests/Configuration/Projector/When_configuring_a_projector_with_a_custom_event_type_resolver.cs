...
public class When_configuring_a_projector_with_a_custom_event_type_resolver
{
    ...
    public When_configuring_a_projector_with_a_custom_event_type_resolver()
    {
        ...
        options.SerializationOptions.UseCustomEventTypeResolver<CustomEventTypeResolver>();
        _ = new ProjectorConfigurator<TestProjector>(projectoRConfigurator, options);
    }
